#!/bin/bash
# Protect against destructive or file-modifying bash commands in a Fallout: New Vegas
# modding environment.
#
# SETUP: the YesMan AI installer (installer/configure.py) fills in {{JQ_PATH}} below. To do it manually:
